...
export const metadata = { 
    ...
    description: 
        'WannaCry is a self-propagated malware, classified as crypto-ransomware, that spread around the internet infecting over 250k computers in more than 150 countries.',
    alternates: { 
        canonical: '/posts/wannacry-ransomware', 
    }, 
};
