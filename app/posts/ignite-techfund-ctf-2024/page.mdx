...
export const metadata = { 
    ...
    description: 
        'This is a pre-qualification round write-up for Ignite CTF 2024. In this write-up I have covered crypto, mobile and forensics categories.',
    alternates: { 
        canonical: '/posts/ignite-techfund-ctf-2024', 
    },
};
